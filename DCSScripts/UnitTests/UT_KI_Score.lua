...
function()
  ...
  if true then
    ...
    UT.TestCompare(function() return KI.Data.GameEventQueue[2]["Airfield"] == KI.Null end)
  ...
  if true then
    ...
    UT.TestCompare(function() return KI.Data.GameEventQueue[3]["Airfield"] == KI.Null end)

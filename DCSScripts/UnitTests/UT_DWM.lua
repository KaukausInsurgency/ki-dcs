...
UT.TestCase("DWM", 
    ...
    function()
      ...
      UT.TestCompare(function() return _d:Take("Building", 1) == true end)
      UT.TestCompare(function() return _d.Resources["Building"].qty == 1 end)
      UT.TestCompare(function() return _d.Resources["Building"].cap == 5 end)
      
      UT.TestCompare(function() return _d:Take("Tanks", 10) == true end)
      UT.TestCompare(function() return _d.Resources["Tanks"].qty == 20 end)
      UT.TestCompare(function() return _d.Resources["Tanks"].cap == 2 end)
      UT.TestCompare(function() return _d.CurrentCapacity == 74 end)
      
      UT.TestCompare(function() return _d:Take("Tanks", 40) == false end)
      UT.TestCompare(function() return _d:Take("TestKey", 22) == false end)
      ...
      UT.TestCompare(function() return _d:Give("Building", 1) == true end)
      UT.TestCompare(function() return _d.Resources["Building"].qty == 2 end)
      UT.TestCompare(function() return _d.Resources["Building"].cap == 5 end)
      
      UT.TestCompare(function() return _d:Give("Tanks", 10) == true end)
      UT.TestCompare(function() return _d.Resources["Tanks"].qty == 30 end)
      UT.TestCompare(function() return _d.Resources["Tanks"].cap == 2 end)
      UT.TestCompare(function() return _d.CurrentCapacity == 100 end)
      
      UT.TestCompare(function() return _d:Give("Tanks", 40) == false end)
      UT.TestCompare(function() return _d:Give("TestKey", 22) == false end)
